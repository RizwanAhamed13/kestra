...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {name: "executions/update/outputs", path: "outputs", component: () => import("../components/executions/outputs/Wrapper.vue"), meta: {tab: "outputs", maximized: true, noOverflow: true}},
